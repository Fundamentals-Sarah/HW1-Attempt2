...
```{r}
grep(pattern = "Country|S1|P1|E2|Total",x = names(fragility23),fixed = F,value = T) #I search the data for certain strings of text
```

```{r}
keep=grep("Country|S1|P1|E2|Total",names(fragility23),fixed = F,value = T)
frag23_sub=fragility23[,keep] #I indicate what I am keeping for strings, to transform fragility23 into a subset, or sub-orject, that I will work with
```
